			...
			menu: [
				{
					...
					onclick: function() {
						editor.windowManager.open( {
							...
							onsubmit: function( e ) {
								editor.insertContent( '[tnc-pdf-viewer-link file="' + e.data.file + '" target="' + e.data.linktarget + '" download="' + e.data.download + '" print="' + e.data.print + '" fullscreen="' + e.data.fullscreen + '" share="' + e.data.share + '" zoom="' + e.data.zoom + '" open="' + e.data.open + '" pagenav="' + e.data.pagenav + '" logo="' + e.data.logo + '" find="' + e.data.find + '" current_view="' + e.data.current_view + '" rotate="' + e.data.rotate + '" handtool="' + e.data.handtool + '" doc_prop="' + e.data.doc_prop + '" toggle_menu="' + e.data.toggle_menu + '" language="' + e.data.v_language + '" class="' + e.data.linkclass + '" text="' + e.data.linktext + '" page="' + e.data.jumptopage + '" default_zoom="' + e.data.defaultzoom + '" pagemode="' + e.data.pagemode + '"]');
							}
						});
					}
				},
				...
				// Iframe Menu Start
				{
					...
					onclick: function() {
						editor.windowManager.open( {
							...
							onsubmit: function( e ) {
								editor.insertContent( '[tnc-pdf-viewer-iframe file="' + e.data.file + '" width="' + e.data.iframewidth + '" height="' + e.data.iframeheight + '" download="' + e.data.download + '" print="' + e.data.print + '" fullscreen="' + e.data.fullscreen + '" share="' + e.data.share + '" zoom="' + e.data.zoom + '" open="' + e.data.open + '" pagenav="' + e.data.pagenav + '" logo="' + e.data.logo + '" find="' + e.data.find + '" current_view="' + e.data.current_view + '" rotate="' + e.data.rotate + '" handtool="' + e.data.handtool + '" doc_prop="' + e.data.doc_prop + '" toggle_menu="' + e.data.toggle_menu + '" language="' + e.data.v_language + '" page="' + e.data.jumptopage + '" default_zoom="' + e.data.defaultzoom + '" pagemode="' + e.data.pagemode + '"]');
							}
						});
					}
				},
