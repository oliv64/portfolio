...
//retrieve options
$find                 = get_option('hide_find');
$pagenav              = get_option('hide_pagenav');
$share                = get_option('hide_share');
$zoom                 = get_option('hide_zoom');
$logo_image_url       = get_option('logo_image');
$logo                 = get_option('hide_logo');
$print                = get_option('hide_print');
$open                 = get_option('hide_open');
$download             = get_option('hide_download');
$fullscreen           = get_option('hide_fullscreen');
$current_view         = get_option('hide_current_view');
$rotate               = get_option('hide_rotate');
$handtool             = get_option('hide_handtool');
$doc_prop             = get_option('hide_doc_prop');
$toggle_menu          = get_option('hide_toggle_menu');
$custom_css           = get_option('pdf_viewer_custom_css');
$viewer_language      = get_option('tnc_pdf_lang'); // Added in 6.1
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  ...
  <body tabindex="1" class="loadingInProgress" oncontextmenu="return true">
